...
layui.define(['admin', 'table', 'index','element','form','laydate', 'jsTools'], function(exports){
    ...
    form.render(null,'scm-outgoing-quote-formlist');
    ...
    element.on('tab(scm-outgoing-quote-tabs-brief)', function (data) {
    ...
    form.on('submit(LAY-scm-outgoing-quote-search)', function (data) {
