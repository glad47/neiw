...
//－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－ 文章博客管理
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'articleType', title: '文章类型', align:'center', width: 114,templet:'#Tabtb-feedback-type'}
            ,{field:'articleUserName', title: '文章发布用户', align:'center', width: 130}
            ,{field:'articleStatus', title: '文章状态', align:'center', width: 114 ,templet: '#Tabtb-feedback-management-status'}

            ,{title: '操作', width: 360, align:'center', fixed: 'right', toolbar: '#Tabtb-feedback-management-option'}
        ]]
