...
//－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－－ 文章博客管理
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'articleType', title: '文章类型', align:'center',templet:'#Tabtb-feedback-type'}
            ,{field:'articleUserName', title: '文章发布用户', align:'center'}
            ,{field:'articleStatus', title: '文章状态', align:'center',templet: '#Tabtb-feedback-management-status'}
