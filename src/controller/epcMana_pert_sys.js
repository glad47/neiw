        ...
        switch (obj.event) {
                    ...
                    admin.req({
                        ...
                        success: function (res) {
                            if (res.pcbInfo == null) {
                                ...
                                layer.alert('当前评审已经添加了评审订单，请勿重复添加！');
                            }
                        }
                    });
                }
            ...
            case 'submit':
                ...
                if (data.length>1) {
                    ...
                    admin.req({
                        type: 'post',
                        url: setter.baseUrl + 'pert/pcbinfo/info/' + data[0].id,
                        success: function (res) {
                            if (res.pcbInfo != null) {
            ...
            admin.req({
                ...
                success: function (res) {
                    ...
                    if (res.pcbInfo != null) {
                        ...
                        layer.alert('当前订单不存在pcb参数信息，添加选择表格左上角的添加按钮', function () {
                            layer.closeAll();
                        });
                    }
                }
